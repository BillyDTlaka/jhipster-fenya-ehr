...
@RestController
@RequestMapping("/api/fenya-tlala-ehr-kafka")
public class FenyaTlalaEhrKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FenyaTlalaEhrKafkaResource.class);
    ...
    public FenyaTlalaEhrKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
